...
#AUTHOR : DARLIHOT
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO DARLIHOT
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/DARLIHOT/DARLIHOT")
			os.system("rm -rf DARLIHOT.py")
			os.system("cp -f DARLIHOT/DARLIHOT.py \\.")
